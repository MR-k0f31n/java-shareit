...
public class ItemController {
    ...
    @GetMapping
    public List<ItemDto> getAllItemsByOwner(@RequestParam Integer from,
    ...
    @PostMapping
    public ItemDto createNewItem(@RequestHeader("X-Sharer-User-Id") Long ownerId, @RequestBody ItemInputDto itemDto) {
    ...
    @GetMapping("/search")
    public List<ItemDto> searchItem(@RequestParam Integer from,
                                    @RequestParam Integer size,
